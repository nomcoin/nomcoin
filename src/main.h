...
#ifndef nomcoin_MAIN_H
#define nomcoin_MAIN_H
...
static const unsigned int MAX_TX_COMMENT_LEN = 268; // nomcoin: 256 bytes + 12 little extra
...
public:
    ...
    */
    ...
    /** Amount of nomcoins spent by this transaction.
    ...
    /** Amount of nomcoins coming in to this transaction
...
public:
    ...
    {
        // Protocol switch to support p2pool at nomcoin block #9689
        ...
        // Before nomcoin block #9689 - old protocol
